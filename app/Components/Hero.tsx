    ...
    <div className="w-full 1000px:flex items-center">
      ...
      <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
        ...
        <p className="dark:text-[#edfff4] text-[#000000ac] font-Josefin font-[600] text-[18px] 1500px:!w-[55%] 1100px:!w-[78%]">
          We have 20k+ Online courses &amp; 500K+ Online registered student.
        ...
        <div className="1500px:w-[55%] 1100px:w-[78%] w-[90%] h-[50px] bg-transparent relative">
          <input
            ...
            value=""
          />
          <div className="absolute flex items-center justify-center w-[50px] cursor-pointer h-[50px] right-0 top-0 bg-[#39c1f3] rounded-r-[5px]"></div>
        </div>
        <br />
        <br />
        <div className="1500px:w-[55%] 1100px:w-[78%] w-[90%] flex items-center">
          <Image
            ...
            height={46}
            decoding="async"
            src={require("../../public/images/client-1.jpg")}
          ...
          <Image
            ...
            height={46}
            decoding="async"
            src={require("../../public/images/client-2.jpg")}
          ...
          <Image
            ...
            height={46}
            decoding="async"
            src={require("../../public/images/client-3.jpg")}
            className="rounded-full ml-[-20px]"
          />
